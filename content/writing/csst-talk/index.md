...
![Disk substructures in different wavelengths.](image.png)
...
![Where lies CSST's operating range?](image-2.png)
...
![Synthetic observation pipeline](image-3.png)
...
- Reference Differential Imaging (RDI) using VIP to recover planetary signals.[^1]

{{< video "preview-11061.mov" "Solar system hydrodynamics" >}}

![Solar system planets embedded in the disk.](image-5.png)
